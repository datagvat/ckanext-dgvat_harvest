...
class DataOoeGvAtHarvester(CKANHarvester):
    ...
    def info(self):
        return {
            'name': 'custom_ooe',
            'title': 'Custom API Import (OOE)',
            'description': 'CKAN Harvester modified for importing data from ooe.gv.at',
    ...
    def fetch_stage(self,harvest_object):
        log.debug('In OOEHarvester fetch_stage')
